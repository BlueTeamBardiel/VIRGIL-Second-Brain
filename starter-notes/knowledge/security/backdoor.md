...
> ⚠️ All exercises below must be performed in an **isolated lab network** (e.g., a dedicated homelab VLAN with no Internet routing). Never run these on production systems or without explicit authorization.
