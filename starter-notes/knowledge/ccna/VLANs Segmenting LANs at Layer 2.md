...
- [[Layer 2]] segmentation with [[subnets]] divides networks logically, but switches operate at [[Layer 2]] and are **broadcast domain unaware**
...
**Definition:** Virtual LANs (VLANs) divide a single physical [[switch]] into multiple virtual switches, creating multiple isolated [[Broadcast Domain]].
