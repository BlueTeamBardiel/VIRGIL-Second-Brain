...
**Primary Role**: Connect devices *within* a [[VLAN]]
...
**Primary Role**: Connect [[VLAN|LANs]] to other LANs and external networks (especially the internet)

**Key Characteristics**:
- Placed at the *edge* of a LAN
- Operates at [[Layer 2]] ([[Network Layer]])
...
- Can operate at multiple layers ([[Layer 2]]/[[Layer 2]] through [[Layer 2]])
