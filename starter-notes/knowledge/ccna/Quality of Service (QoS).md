...
**The technical detail:** Normally, an [[Access Point]] belongs to exactly one VLAN. But voice VLAN is a special exception:
...
|--------|-------|------|-------|---------|
| [[RTO]] (Type of Service) | IP Header | 8 | 0–255 | Old way, rarely used |
