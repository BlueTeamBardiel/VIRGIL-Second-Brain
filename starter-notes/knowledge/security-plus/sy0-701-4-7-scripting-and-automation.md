...
- [[Wazuh]] – Open-source SIEM/XDR used in Morpheus's homelab; can execute automated response scripts on rule matches.
- [[Tailscale]] – Zero-trust VPN; automation can enroll devices and manage access policies via [[API]].
- [[[YOUR-LAB]]] – Morpheus's homelab infrastructure; a prime use case for scripting and orchestration.
