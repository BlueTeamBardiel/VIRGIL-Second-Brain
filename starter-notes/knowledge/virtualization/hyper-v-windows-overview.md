...
Hyper-V is Microsoft's enterprise-grade type-1 hypervisor built into Windows Server and Windows, enabling organizations to create, manage, and run virtual machines at scale with near-native performance and robust workload isolation.
