...
- **[[[YOUR-LAB]]] placement:** [[[YOUR-HOST]]] is the designated network IDS/forensic logging host — see Phase 2.5
...
- Examples: `iptables` rules, ACLs on [[[YOUR-HOST]]] (Cisco 3850)
...
- [[[YOUR-HOST]]] (Cisco 3850) is the [YOUR-LAB] inter-VLAN routing device
- Current [YOUR-LAB] is mostly flat (192.168.x.x/24) — segmentation is a future hardening goal
...
**Prevention:** DNSSEC, use trusted resolvers ([[Pi-hole]] on [[[YOUR-HOST]]]), monitor for unexpected DNS changes
