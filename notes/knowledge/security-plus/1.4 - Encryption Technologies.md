...
In Morpheus's [[COCYTUS]] homelab environment, understanding these technologies is critical for production readiness:

- **Endpoint Protection**: Every COCYTUS node with TPM 2.0 can enable [[BitLocker]] or LUKS encryption at rest, protecting lab VMs if physical drives are accessed. The TPM stores the volume master key, preventing cold-boot attacks.
...
[[COCYTUS]], [[Active Directory]], [[Tailscale]], [[Wazuh]], [[SIEM]], [[HashiCorp Vault]]
