...
In Morpheus's **COCYTUS** homelab, [[DLP]] concepts apply to protecting secrets in [[Active Directory]], API keys in [[Tailscale]] configurations, and sensitive logs in [[Wazuh]]. **SNMP monitoring** on network switches and [[Pi-hole]] DNS appliance provides health data feed into [[Wazuh]] for anomaly detection. **NetFlow** from routers supplments [[Wazuh]]'s network monitoring, giving visibility into which internal systems communicate with external hosts. **Vulnerability scanners** (e.g., [[Nessus]], [[OpenVAS]]) running against COCYTUS VMs identify patch gaps and misconfigurations before they're exploited in simulated [[Incident Response]] drills.
...
## Chat Import Update — 2026-04-27

Test content: we discussed port security and 802.1X authentication.

*Source: `notes/chat-imports/security/2026-04-27-1747-port-security-and-8021x.md`*

## Chat Import Update — 2026-04-27

Test content: we discussed port security and 802.1X authentication.

*Source: `notes/chat-imports/security/2026-04-27-1750-port-security-and-8021x.md`*