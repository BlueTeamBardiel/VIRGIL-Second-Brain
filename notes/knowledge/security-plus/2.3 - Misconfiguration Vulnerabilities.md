...
In Morpheus's [[COCYTUS]] homelab, misconfiguration vulnerabilities could manifest as:
...
- [[COCYTUS]] — Morpheus's homelab fleet; example environment for applying misconfiguration mitigations
