...
- [[COCYTUS]] – Morpheus's homelab infrastructure; a prime use case for scripting and orchestration.
...
**Lab Exercise:**
In COCYTUS, write a bash or Python script that:
