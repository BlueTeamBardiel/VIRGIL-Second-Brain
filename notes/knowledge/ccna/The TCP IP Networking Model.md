...
|--------------|----------------|---------|---------------|
| **Application (Layer 4)** | 5, 6, 7 | User services, applications | [[HTTP]], [[HTTPS]], [[SMTP]], [[POP3]], [[IMAP]], [[DNS]], [[DHCP]], [[SSH]], [[Telnet]], [[FTP]], [[TFTP]] |
...
- **[[Ethernet]]:** The standard for LAN communication
  ...
  - Uses [[MAC addresses]] for local addressing (48-bit addresses like 00:1A:2B:3C:4D:5E)
...
| [[HTTPS]] | 443 | Web browsing (encrypted) | TCP |
...
| [[TFTP]] | 69 | Trivial file transfer (no auth) | UDP |
...
### Web Stack
1. **Browser requests page:** [[HTTP]]/[[HTTPS]] (ports 80/443) → [[TCP]] → IP → Ethernet
