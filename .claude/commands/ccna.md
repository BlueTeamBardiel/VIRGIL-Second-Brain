...
Read:
- `/home/your-username/VIRGIL/memory.md` — check CCNA weak areas if any are noted
- `/home/your-username/VIRGIL/notes/CCNA.md` — if it exists, check recent session log to avoid repeating the same questions
