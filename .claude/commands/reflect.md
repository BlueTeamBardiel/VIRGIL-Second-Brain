...
## Step 5 — Mark completed tasks in memory.md

Read the `## 🔴 High Priority Pending Tasks`, `## 🟡 Medium Priority Pending Tasks`, and `## 🟢 Low Priority Pending Tasks` sections of memory.md.
...
Then check if a `## ✅ Completed Tasks` section exists in memory.md.
